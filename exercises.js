...
console.log("multiply first then divide by a product of 2 #'s:" , multiplyThenDivide (bango3, bango4, bango5));
...
* Console.log your result. 
*/
function shoeSize (inches, inCentimeters){
   return ("Enter your shoe size in inches: " + x + " ;  shoe size in centimeters: " + multiply(x,2.54));
}
/*
* main program
*/
var x = 12;
var inCentimeters = 0;
console.log (shoeSize (x, inCentimeters));
